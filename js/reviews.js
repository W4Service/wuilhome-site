...
(function() {
    ...
    const platformIcons = {
        ...
        'BookingCom': '<svg width="14" height="14" viewBox="0 0 24 24" fill="#003580"><rect width="24" height="24" rx="2" fill="#003580"/><text x="12" y="17" text-anchor="middle" font-family="Arial,sans-serif" font-size="16" font-weight="bold" fill="white">B</text></svg>',
        'Booking': '<svg width="14" height="14" viewBox="0 0 24 24" fill="#003580"><rect width="24" height="24" rx="2" fill="#003580"/><text x="12" y="17" text-anchor="middle" font-family="Arial,sans-serif" font-size="16" font-weight="bold" fill="white">B</text></svg>'
    };
