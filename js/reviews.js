        ...
        card.innerHTML = `
            <div class="review-header">
                <div class="review-guest-info">
                    <div class="review-name">${review.guest_name}</div>
                    <div class="review-date">${formatDate(review.date)}</div>
                </div>
                <div class="review-platform-logo">${platformIcon}</div>
            </div>
