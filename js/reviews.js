...
(function() {
    ...
    const platformIcons = {
        ...
        'BookingCom': '<svg width="14" height="14" viewBox="0 0 32 32" fill="#003580"><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Arial, sans-serif" font-size="20" font-weight="bold" fill="#003580">B</text></svg>',
        'Booking': '<svg width="14" height="14" viewBox="0 0 32 32" fill="#003580"><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Arial, sans-serif" font-size="20" font-weight="bold" fill="#003580">B</text></svg>'
    };
